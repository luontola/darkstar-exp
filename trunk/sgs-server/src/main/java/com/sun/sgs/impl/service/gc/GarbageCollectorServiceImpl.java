...
package com.sun.sgs.impl.service.gc;
...
//        System.out.println("marked " + id + " " + color);
    ...
    private class MarkAllRootsGray extends AbstractKernelRunnable {
        ...
        public void run() throws Exception {
            for (String binding = dataService.nextBoundName(null);
                 binding != null;
                 binding = dataService.nextBoundName(binding)) {
//                System.out.println("binding = " + binding);
                ManagedObject obj = dataService.getBinding(binding);
                shadeToGray(getId(obj));
            }
            for (String binding = dataService.nextServiceBoundName(null);
                 binding != null;
                 binding = dataService.nextServiceBoundName(binding)) {
//                System.out.println("binding = " + binding);
